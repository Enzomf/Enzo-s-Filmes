    ...
    let response = [
      {
        ...
        content: await (
          await fetch(
            `https://api.themoviedb.org/3/tv/popular?api_key=4db00bcf6b586a0afd9fb29afa56fa26&language=en-US&page=2`
          )
        ).json(),
      },
      {
        ...
        content: await (
          await fetch(
            `https://api.themoviedb.org/3/discover/tv?api_key=4db00bcf6b586a0afd9fb29afa56fa26&language=en-US&sort_by=popularity.desc&page=1&timezone=America%2FNew_York&include_null_first_air_dates=false`
          )
        ).json(),
      },
      {
        ...
        content: await (
          await fetch(
            `https://api.themoviedb.org/3/tv/top_rated?api_key=4db00bcf6b586a0afd9fb29afa56fa26&language=en-US&page=1`
          )
        ).json(),
      },
      {
      ...
      },
      {
        ...
        content: await (
          await fetch(
            `https://api.themoviedb.org/3/discover/tv?api_key=4db00bcf6b586a0afd9fb29afa56fa26&page=2&with_genres=9648`
          )
        ).json(),
      },
      {
        ...
        content: await (
          await fetch(
            `https://api.themoviedb.org/3/discover/tv?api_key=4db00bcf6b586a0afd9fb29afa56fa26&page=2&with_genres=35`
          )
        ).json(),
      },
      {
        ...
        content: await (
          await fetch(
            `https://api.themoviedb.org/3/discover/tv?api_key=4db00bcf6b586a0afd9fb29afa56fa26&page=1&with_genres=16`
          )
        ).json(),
      },
    ];
